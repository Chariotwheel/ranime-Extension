...
var cf = true; var as = true; var sp = false;

chrome.storage.local.get("opcommentfaces",
function(obj) {
  if(obj.opcommentfaces !== undefined) {
    cf = obj.opcommentfaces;
  }
  else {
    cf = true;
  }
...
function getSearch() {
  chrome.storage.local.get("opanisearch",
  function(obj) {
    if(obj.opanisearch !== undefined) {
      as = obj.opanisearch;
    }
    else {
      as = true;
...
function getSpoiler() {
  chrome.storage.local.get("opspoiler",
  function(obj) {
    if(obj.opspoiler !== undefined) {
      sp = obj.opspoiler;
    }
    else {
      sp = true;
